namespace RXcx03._07.Models
{
    ...
    [Table("futian_user.TJ_TJJLB")]
    public partial class TJ_TJJLB
    {
        [Key]
        ...
        [StringLength(255)]
        public string HBXM { get; set; }

        [StringLength(255)]
        public string MRBCLJ { get; set; }

        [StringLength(50)]
        public string SQDH { get; set; }

        [StringLength(1)]
        public string DJISOVER { get; set; }
